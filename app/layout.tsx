...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Produtos digitais que eliminam ruído e deixam a operação mais leve.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Matheus D'Alkmin — Sistemas web sob medida" }],
  },
};
